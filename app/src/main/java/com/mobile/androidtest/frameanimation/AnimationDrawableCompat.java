package com.mobile.androidtest.frameanimation;
...
public class AnimationDrawableCompat {
    public static Drawable getDrawable(Resources res, TypedArray array, int index) {
        ...
        Drawable drawable = loadFromXml(value, res);
        return drawable;
    }

    public static Drawable loadFromXml(TypedValue value, Resources res) {
        try {
    ...
    public static Drawable createFromXmlInner(Resources r, XmlPullParser parser, AttributeSet attrs,
        ...
        if (name.equals("animation-list")) {
            drawable = new LazyAnimationDrawable();
        } else {
